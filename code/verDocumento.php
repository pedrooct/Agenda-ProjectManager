...
<body>
	<div class="header">
		<div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
			...
			<a class="pure-menu-heading" href="dashboard"> Documentos!</a>
			<a href="dashboard">
...
<div class="content">
	...
	<div class="pure-g">
		<?php
		$data=$ask->getUserDocsSent($perfil_id);
		while($row= mysqli_fetch_assoc($data))
		{
			$doc=$ask->getDocumento($row['mongoID']);
			$file=base64_decode($doc->ficheiro);
			?>
			<div class=".pure-u-1-1 pure-u-sm-1-1 pure-u-md-1-1 pure-u-lg-1-2">
				<div class="columns">
					<ul class="price">
						<li class="headerBox"> <?php echo $doc->nome; ?></li>
						<li class="grey">Notas: <?php echo $doc->notas; ?></li>
						<li class="grey">
							<object class="filesShow" type= <?php echo $doc->tipo;?> data=<?php echo "data:".$doc->tipo.";base64,".$doc->ficheiro;?>></object>
						</li>
						<li class="grey">
							<a href=<?php echo "scripts/download?mid=".$row['mongoID'] ?>>
...
<div class="content">
	...
	<div class="pure-g">
		<?php
		$data=$ask->getUserDocsReceive($perfil_id);
		while($row= mysqli_fetch_assoc($data))
		{
			$doc=$ask->getDocumento($row['mongoID']);
			$file=base64_decode($doc->ficheiro);
