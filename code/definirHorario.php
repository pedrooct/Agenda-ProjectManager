...
<body>
	<div class="header">
		<div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
			...
			<div>
				<form method="post">
					<button type="submit" name="skip"  class="pure-button pure-button-primary">Clique aqui para saltar este passo !!</button>
				</form>
			</div>
		</div>
		<div class="success">Verifique o seu email para mais instruções... </div>
		<?php
		if(isset($_POST['skip']))
		{
		...
		if(isset($_POST['confirm']))
		{
			...
			$schedule= new Ask();
			$response=$schedule->horarioLivreJson($horario,$semail);
			if($response)
			{
				header('location: login');
			}
